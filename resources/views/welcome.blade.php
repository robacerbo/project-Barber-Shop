<x-layout>
    ...
    <div id="Academy" class="container-fluid py-5 myContAcademy">
        ...
        <div class="row align-items-center justify-content-center text-center pt-3">
            <div class="col-12 p-0 m-0 colUtlimiCorsi px-3 m-0">
        ...
        <div class="row px-md-5 p-3 h-100">
            @foreach($courses as $course)
            <x-course-card :course="$course"/>
            @endforeach
        </div>
        <div class="d-flex justify-content-center py-5">
            <a href="{{route('course.index')}}"><button class="btn btn-light btn-lg rounded-0 btnPrenota tx-m">Tutti i nostri Corsi</button></a>
        </div>
